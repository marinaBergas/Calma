...
const BlogsHome = (props) => {
  return (
    <>
      <div className="blog-header row justify-content-center">
         <div className="col-sm-12">
            <h3>Calma Blog</h3>
            <p>The more you read the more you know about yourself</p>
         </div>
      </div>

      <div className="blog-container row justify-content-center">
