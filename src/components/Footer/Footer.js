            ...
            <div className="container">
                <div className=" row-grid align-items-center mb-5 row">
                    <div className="col-lg-6 text-left">
                       <h4 className=" text-white font-weight-light mb-2 pl-0">Thank you for supporting us!</h4>
                      <h5 className=" mb-0 font-weight-light text-white">Let's get in touch on any of these platforms.</h5>
                    </div>
                    <div className="text-lg-center btn-wrapper col-lg-6 mt-4 text-left">
                   ...
                   <div className="col-md-6">
                    <ul className=" nav-footer justify-content-end ">
                        <li className="nav-item ">
                            <Link to="/about"   className="footer-link text-white m-2">About Us</Link>
                        </li>
                        <li className="nav-item  ">
                            <Link  to="/blogs"  className="footer-link text-white m-2">Blog</Link>
                        </li>
                        <li className="nav-item  ">
                            <Link to="/privace"   className="footer-link text-white m-2">Privacy and Policy</Link>
                        </li>
                    </ul>
                    </div>
                </div>
